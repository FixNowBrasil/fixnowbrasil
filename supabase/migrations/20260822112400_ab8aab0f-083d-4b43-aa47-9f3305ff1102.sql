ALTER FUNCTION public.create_request_with_matching(uuid,uuid,uuid,text,text,text[],text,timestamptz,text,text)
  RENAME TO create_request_with_matching_v1;
DROP FUNCTION public.create_request_with_matching_v1(uuid,uuid,uuid,text,text,text[],text,timestamptz,text,text);
...
REVOKE ALL ON FUNCTION public.create_request_with_matching(uuid,text,text,text,uuid,uuid,text,text[],timestamptz,text) FROM public, anon;
GRANT EXECUTE ON FUNCTION public.create_request_with_matching(uuid,text,text,text,uuid,uuid,text,text[],timestamptz,text) TO authenticated;